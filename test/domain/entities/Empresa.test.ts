...
describe("Empresa", () => {
  ...
  it("should throw if id is empty", () => {
    expect(() =>
      Empresa.crear("", validCUIT, validRazonSocial, validFecha),
    ).toThrow("El id no puede estar vacío");
  });

  it("should throw if fecha is undefined", () => {
    expect(() =>
      Empresa.crear(validId, validCUIT, validRazonSocial, undefined as any),
  ...
  it("should throw if fecha is in the future", () => {
    ...
    expect(() =>
      Empresa.crear(validId, validCUIT, validRazonSocial, futureDate),
  ...
  it("should throw with empty razón social", () => {
    expect(() => Empresa.crear(validId, validCUIT, "", validFecha)).toThrow();
  });
});
