...
describe('Importe', () => {
  ...
  it('should throw on 0', () => {
    expect(() => new Importe(0)).toThrow('El importe debe ser un número positivo mayor a 0.');
  });

  it('should throw on negative value', () => {
    expect(() => new Importe(-5)).toThrow('El importe debe ser un número positivo mayor a 0.');
  });

  it('should throw on NaN', () => {
    expect(() => new Importe(NaN)).toThrow('El importe debe ser un número positivo mayor a 0.');
  });
